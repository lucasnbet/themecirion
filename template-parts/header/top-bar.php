...
<div class="buscador2025">
    <?php
    wp_nav_menu(array(
        'theme_location' => 'buscador', // Ubicación del menú en el tema
        'menu' => 'buscador', // Nombre del menú
        'container' => false, // Evita que envuelva el menú en un <div>
        'menu_class' => 'mi-clase-menu', // Clase CSS opcional para el <ul>
        'fallback_cb' => false // No mostrar nada si el menú no existe
    ));
    ?>
</div>
